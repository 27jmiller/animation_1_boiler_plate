...
# import assets
sprite_sheet = pygame.image.load("Walking Guy (1).png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 9 # code the number of sprite images your sprite sheet has
